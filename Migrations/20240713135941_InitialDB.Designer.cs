...
namespace library_server.Migrations
{
    ...
    [Migration("20240713135941_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("library_server.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library_server.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library_server.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library_server.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "admin1990",
                            UserType = "ADMIN",
                            createdOn = new DateTime(2024, 7, 13, 17, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("library_server.Entities.Book", b =>
                {
                    b.HasOne("library_server.Entities.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("library_server.Entities.Order", b =>
                {
                    b.HasOne("library_server.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("library_server.Entities.User", "User")
                        .WithMany()
