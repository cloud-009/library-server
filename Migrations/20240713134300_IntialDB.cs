        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetrunDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccountStatus", "Email", "FirstName", "LastName", "MobileNumber", "Password", "UserType", "createdOn" },
                values: new object[] { 1, "ACTIVE", "admin@gmail.com", "Admin", "", "9876543210", "admin1990", "ADMIN", new DateTime(2024, 7, 13, 17, 0, 0, 0, DateTimeKind.Unspecified) });
